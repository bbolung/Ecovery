...
## 📄 프로젝트 소개
**Ecovery**는 AI 사물인식을 활용한 대형 폐기물 분리배출 안내 및 친환경 마켓 플랫폼입니다.
  * 사용자가 업로드한 대형 폐기물 사진을 인식하여 품목별 올바른 분리배출 방법을 안내합니다.
  * 불필요한 자원 낭비를 방지하기 위해 상태가 좋은 대형 폐기물을 나눔할 수 있는 무료나눔 게시판을 제공합니다. 
  * 친환경 제품을 구입할 수 있는 에코마켓 게시판을 제공합니다.
